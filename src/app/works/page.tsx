...
const page = () => {
  return (
<div className="bg-[#282C34] w-full text-white py-0" id="work">
      ...
      <div className="flex space-x-4 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-gray-300">
        <div className="border border-[#ACB2CF] self-start flex-shrink-0">
          ...
          <div className="text-[#ACB2CF] mt-2">
            <div className="p-2"><p>HTML SCSS Python Flask</p></div>
            <div className="p-4 border-t border-[#ACB2CF]">
              ...
              <div className="flex gap-4 mt-4">
                <button className="inline-block border border-[#C778DE] py-2 px-4 text-white">Live &lt;~&gt;</button>
                <button className="inline-block text-[#ACB2CF] [#ACB2CF] border border-[#C778DE] py-2 px-4 text-white">Cached &gt;=</button>
              </div>
            </div>
          </div>
        </div>
        <div className="border border-[#ACB2CF] self-start flex-shrink-0">
          ...
          <div className="text-[#ACB2CF] mt-2 text-lg">
            ...
            <div className="p-4 border-t border-[#ACB2CF]">
              ...
              <div className="flex gap-4 mt-4"><button className="inline-block border border-[#C778DE] py-2 px-4 text-white">Live &lt;~&gt;</button></div>
            </div>
          </div>
        </div>
        <div className="border border-[#ACB2CF] self-start flex-shrink-0">
          <img
            ...
            className="w-full h-auto" />
          <div className="text-[#ACB2CF] mt-2 text-lg">
            <div className="p-2"><p>CSS Express Node.js</p></div>
            <div className="p-4 border-t border-[#ACB2CF]">
